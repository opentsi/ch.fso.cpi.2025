...
[![dataset](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/opentsi/ch.fso.cpi.2025/master/data-raw/shield.json)](https://github.com/opentsi/ch.fso.cpi.2025/actions/workflows/update_data.yaml)
...
ts <- read_open_ts(series = "ttl",
  remote_archive = "opentsi/ch.fso.cpi.2025"
)
ts202603 <- read_open_ts(series = "ttl",
  remote_archive = "opentsi/ch.fso.cpi.2025",
  date = "2026-03-01"
)
